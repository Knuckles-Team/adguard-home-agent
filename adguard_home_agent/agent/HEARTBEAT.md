...
5. **Domain-Specific Checks**:
   - **Blocking Stats**: Summarize blocked requests and identify top blocked domains.
   - **System Status**: Check if DNS blocking is actively running and if there are pending updates for AdGuard Home.
