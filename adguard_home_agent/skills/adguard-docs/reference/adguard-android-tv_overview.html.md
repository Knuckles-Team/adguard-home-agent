...
Watch the video: How to install AdGuard for Android TV
![AdGuard product video](https://cdn.adguardcdn.com/website/adguard.com/video/android-tv/video-preview-en.png)
Prefer to read? Here are the instructions
Installing
from TV browser
[ Read ](https://adguard.com/en/adguard-android-tv/browser/overview.html?utm_source=android_tv_main)
Installing
from desktop
[ Read ](https://adguard.com/en/adguard-android-tv/desktop/overview.html?utm_source=android_tv_main)
  * **Block ads on TV**
AdGuard blocks banners, popups, and home screen ads. Watch your favorite movies and TV shows on the big screen and don’t let the ads get in the way!
  * **Protect your data**
User data on TV is often more vulnerable than on computers or mobile phones. AdGuard protects your personal information from apps and websites that try to spy on you
  * **Block phishing and malware**
AdGuard won’t let you download malware or fall victim of fraud. It checks every page against our malware database and blocks requests to potentially dangerous websites
  * **Use secure DNS**
AdGuard is the only way to use encrypted DNS on your Smart TV. Boost your security by encrypting your traffic and block ads and trackers at the DNS level. Supported protocols: DNS-over-HTTPS, DNS-over-TLS, DNSCrypt, and DNS-over-QUIC


##  FAQ
  * You can install AdGuard on your Android TV via your TV browser or via a third-party app on your desktop device. Instructions:
[Installing via a TV browser](https://adguard.com/en/adguard-android-tv/browser/overview.html)
[Installing via a desktop device](https://adguard.com/en/adguard-android-tv/desktop/overview.html)
  * Ad blocking. AdGuard blocks annoying ads in apps and browsers
Tracking protection. AdGuard keeps your user information private by blocking tracking cookies and analytics systems
Browsing Security. AdGuard warns you if you’re about to visit a malicious website
DNS protection. AdGuard allows you to use a DNS server to block ads at the DNS level and encrypt traffic
App management. AdGuard allows you to specify apps for filtering
  * No, AdGuard for Android TV can’t block ads on YouTube.
  * Sure! We have a 60-day money-back guarantee.


  * No, the TV app is only available with an [AdGuard license](https://adguard.com/en/license.html). But you can also try it for free — we offer a 7-day trial period.
  * AdGuard is the only ad blocker for TV. It’s a unique app that blocks ads and trackers, filters DNS requests, and secures your TV traffic.
Plus, AdGuard is the only Android TV app that allows you to use encrypted DNS, which greatly increases the security of DNS requests. Select a server from the list to encrypt DNS requests and block ads at the DNS level, or add your own server to use any protocol — DNS-over-HTTPS, DNS-over-TLS, DNSCrypt, or DNS-over-QUIC.
  * Our friendly support team is here for you 24/7. If you have any questions, contact us at support@adguard.com.


##  Latest news
  * ### [ Introducing AdGuard for Android TV ](https://adguard.com/en/blog/adguard-for-android-tv.html)
Dec 22, 2023
In this post, we'll explore the features that make AdGuard for Android TV a unique tool for ad blocking and instructions on how to install it on your TV.
  * ### [ AdGuard v4.3 for Android: Android TV support and more ](https://adguard.com/en/blog/adguard-v4-3-for-android.html)
Dec 22, 2023
AdGuard v4.3 for Android is here! Get to know our exciting new features, including Android TV support, Developer tools, and more.
  * ### [ Game changer for your Web: Discounts on all AdGuard products ](https://adguard.com/en/blog/winter-promo.html)
Feb 4, 2026
Stay on top of your game this season: get any AdGuard product at a discount and keep your devices protected.
  * ### [ Holiday savings that make your Internet shine ](https://adguard.com/en/blog/new-year-2026.html)
Dec 22, 2025
...
[ Read more ](https://adguard.com/en/blog/tag/adguard-for-android-tv.html)
...
Please try again. If it doesn’t help, please [contact support](https://adguard.com/en/adguard-android-tv/%mailto%)
...
[ Buy AdGuard ](https://adguard.com/en/license.html)
...
[Recent versions](https://adguard.com/en/versions/android-tv/release.html)
[All products](https://adguard.com/en/products.html)
Installation
